...
require_once DIR_BASE ."recommendation-algorithm-main\src\Configuration\StandardKey.php";
require_once DIR_BASE ."recommendation-algorithm-main\src\Interfaces\CollaborativeInterface.php";
